...
const SinglePost = ({ post, handleEdit, image, name, surname, title, text, id }) => {
      ...
      {post && (
        <>
          <div className="profile-sub-section p-2 my-2">
            <Card style={{ width: "540px", borderRadius: "7px", marginLeft: "11.6em" }} className="mb-2 ">
              <Card.Body>
                <div className="d-flex flex-row">
                  ...
                  <span className="d-flex flex-column ml-3">
                    <Link to={pathname === "/" ? `/profile/${post.user._id}` : `/profile/${id}`}>
                      <Card.Title>
                ...
                <Link to={pathname === "/" ? `/profile/${post.user._id}` : `/profile/${id}`}></Link>
